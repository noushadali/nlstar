...
public class CarouselImage extends Image{
	...
	public void setOpacity(double opacity) {
		if (opacity > .995) {
			...
			getElement().getStyle().setProperty("mozOpacity", "");
			getElement().getStyle().setProperty("khtmlOpacity", "");
		} else {
			...
			getElement().getStyle().setProperty("mozOpacity", sDecimal);
			getElement().getStyle().setProperty("khtmlOpacity", sDecimal);
		}
	}
